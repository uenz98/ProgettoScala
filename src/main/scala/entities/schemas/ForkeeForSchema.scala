...
import entities.payloadComponents.{Key, User}

class ForkeeForSchema(archive_url       : String = null,
                      ...
                      owner             :User = null,
                      `private`         :java.lang.Boolean = false,
...
with Product {
  ...
  override def canEqual(that: Any): Boolean = that.isInstanceOf[ForkeeForSchema]
}