...
import entities.payloadComponents.{LinksWrapper2, Milestone, Team, User}

import scala.beans.BeanProperty

class PullRequestForSchema(@BeanProperty _links:LinksWrapper2 = LinksWrapper2(),
                           ...
                           @BeanProperty base:BaseForSchema = null,
...
with Product {
  override def canEqual(that: Any):Boolean = that.isInstanceOf[PullRequestForSchema]
